...
export default function SignUp() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black flex overflow-y-auto">
      {/* Background Video */}
      <video
      ...
      <Link 
        to="/" 
        className="absolute top-6 left-6 z-20 text-white/60 hover:text-white flex items-center gap-2 transition-colors text-sm font-medium bg-black/20 px-4 py-2 rounded-full backdrop-blur-md border border-white/5"
      >
        <ArrowLeft size={16} />
        Back
      </Link>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 w-full h-full py-24">
        {/* Form Container */}
        <div className="w-full max-w-md mx-auto p-8 bg-black/40 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl mt-8">
          <h2 
            className="text-4xl md:text-5xl text-white mb-3 tracking-tight"
          ...
          <button 
            ...
            disabled={loading}
            className="w-full bg-white text-gray-800 font-medium rounded-xl px-4 py-3 mb-6 flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
          >
          ...
          <form className="space-y-4" onSubmit={handleEmailSignUp}>
            <div className="grid grid-cols-2 gap-4">
              <input 
                ...
                className="w-full bg-transparent border border-white/20 rounded-xl px-4 py-3 text-white placeholder:text-white/40 outline-none focus:border-white/50 transition-all text-sm"
              />
              <input 
                type="text" 
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-transparent border border-white/20 rounded-xl px-4 py-3 text-white placeholder:text-white/40 outline-none focus:border-white/50 transition-all text-sm pr-12"
              />
              <button 
                type="button"
            ...
            <div className="flex gap-6 py-2">
              <label className="flex items-center gap-2 text-white/80 text-sm cursor-pointer hover:text-white transition-colors">
                <input 
                  ...
                  className="w-4 h-4 accent-[#E97262] bg-white/10 border-white/20 cursor-pointer"
                />
                Student
              </label>
              <label className="flex items-center gap-2 text-white/80 text-sm cursor-pointer hover:text-white transition-colors">
